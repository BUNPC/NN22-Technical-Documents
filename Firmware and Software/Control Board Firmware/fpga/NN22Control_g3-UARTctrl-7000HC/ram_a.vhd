...
-- Module  Version: 7.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n ram_a -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type bram -wp 11 -rp 1010 -data_width 27 -rdata_width 27 -num_rows 1024 -outdataB REGISTERED -cascade -1 -resetmode SYNC -sync_reset -mem_init0 -writemodeA NORMAL -writemodeB NORMAL 

-- Fri Dec 30 20:35:01 2022
...
architecture Structure of ram_a is
    ...
    attribute MEM_LPC_FILE of ram_a_0_0_2 : label is "ram_a.lpc";
    attribute MEM_INIT_FILE of ram_a_0_0_2 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of ram_a_0_1_1 : label is "ram_a.lpc";
    attribute MEM_INIT_FILE of ram_a_0_1_1 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of ram_a_0_2_0 : label is "ram_a.lpc";
    attribute MEM_INIT_FILE of ram_a_0_2_0 : label is "INIT_ALL_0s";
...
begin
    ...
    ram_a_0_1_1: DP8KC
        ...
        REGMODE_B=> "OUTREG", REGMODE_A=> "NOREG", DATA_WIDTH_B=>  9, 
        DATA_WIDTH_A=>  9)
        port map (DIA8=>DataInA(17), DIA7=>DataInA(16), 
            DIA6=>DataInA(15), DIA5=>DataInA(14), DIA4=>DataInA(13), 
            DIA3=>DataInA(12), DIA2=>DataInA(11), DIA1=>DataInA(10), 
            DIA0=>DataInA(9), ADA12=>AddressA(9), ADA11=>AddressA(8), 
            ADA10=>AddressA(7), ADA9=>AddressA(6), ADA8=>AddressA(5), 
            ADA7=>AddressA(4), ADA6=>AddressA(3), ADA5=>AddressA(2), 
            ADA4=>AddressA(1), ADA3=>AddressA(0), ADA2=>scuba_vlo, 
            ADA1=>scuba_vlo, ADA0=>scuba_vhi, CEA=>ClockEnA, 
            OCEA=>ClockEnA, CLKA=>ClockA, WEA=>WrA, CSA2=>scuba_vlo, 
            CSA1=>scuba_vlo, CSA0=>scuba_vlo, RSTA=>ResetA, 
            DIB8=>DataInB(17), DIB7=>DataInB(16), DIB6=>DataInB(15), 
            DIB5=>DataInB(14), DIB4=>DataInB(13), DIB3=>DataInB(12), 
            DIB2=>DataInB(11), DIB1=>DataInB(10), DIB0=>DataInB(9), 
            ADB12=>AddressB(9), ADB11=>AddressB(8), ADB10=>AddressB(7), 
            ADB9=>AddressB(6), ADB8=>AddressB(5), ADB7=>AddressB(4), 
            ADB6=>AddressB(3), ADB5=>AddressB(2), ADB4=>AddressB(1), 
            ADB3=>AddressB(0), ADB2=>scuba_vlo, ADB1=>scuba_vlo, 
            ADB0=>scuba_vhi, CEB=>ClockEnB, OCEB=>ClockEnB, CLKB=>ClockB, 
            WEB=>WrB, CSB2=>scuba_vlo, CSB1=>scuba_vlo, CSB0=>scuba_vlo, 
            RSTB=>ResetB, DOA8=>QA(17), DOA7=>QA(16), DOA6=>QA(15), 
            DOA5=>QA(14), DOA4=>QA(13), DOA3=>QA(12), DOA2=>QA(11), 
            DOA1=>QA(10), DOA0=>QA(9), DOB8=>QB(17), DOB7=>QB(16), 
            DOB6=>QB(15), DOB5=>QB(14), DOB4=>QB(13), DOB3=>QB(12), 
            DOB2=>QB(11), DOB1=>QB(10), DOB0=>QB(9));
    ...
    ram_a_0_2_0: DP8KC
        ...
        REGMODE_B=> "OUTREG", REGMODE_A=> "NOREG", DATA_WIDTH_B=>  9, 
        DATA_WIDTH_A=>  9)
        port map (DIA8=>DataInA(26), DIA7=>DataInA(25), 
            DIA6=>DataInA(24), DIA5=>DataInA(23), DIA4=>DataInA(22), 
            DIA3=>DataInA(21), DIA2=>DataInA(20), DIA1=>DataInA(19), 
            DIA0=>DataInA(18), ADA12=>AddressA(9), ADA11=>AddressA(8), 
            ADA10=>AddressA(7), ADA9=>AddressA(6), ADA8=>AddressA(5), 
            ADA7=>AddressA(4), ADA6=>AddressA(3), ADA5=>AddressA(2), 
            ADA4=>AddressA(1), ADA3=>AddressA(0), ADA2=>scuba_vlo, 
            ADA1=>scuba_vlo, ADA0=>scuba_vhi, CEA=>ClockEnA, 
            ...
            ADB0=>scuba_vhi, CEB=>ClockEnB, OCEB=>ClockEnB, CLKB=>ClockB, 
            WEB=>WrB, CSB2=>scuba_vlo, CSB1=>scuba_vlo, CSB0=>scuba_vlo, 
            RSTB=>ResetB, DOA8=>QA(26), DOA7=>QA(25), DOA6=>QA(24), 
            DOA5=>QA(23), DOA4=>QA(22), DOA3=>QA(21), DOA2=>QA(20), 
            DOA1=>QA(19), DOA0=>QA(18), DOB8=>QB(26), DOB7=>QB(25), 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of ram_a is
    for Structure
