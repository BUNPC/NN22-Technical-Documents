...
-- Module  Version: 7.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n ram_b -lang vhdl -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 11 -rp 1010 -data_width 18 -rdata_width 18 -num_rows 1024 -outdataB REGISTERED -cascade -1 -resetmode SYNC -sync_reset -mem_init0 -writemodeA NORMAL -writemodeB NORMAL 
...
architecture Structure of ram_b is
    ...
    attribute MEM_LPC_FILE of ram_b_0_0_1 : label is "ram_b.lpc";
    attribute MEM_INIT_FILE of ram_b_0_0_1 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of ram_b_0_1_0 : label is "ram_b.lpc";
    attribute MEM_INIT_FILE of ram_b_0_1_0 : label is "INIT_ALL_0s";
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of ram_b is
    for Structure
