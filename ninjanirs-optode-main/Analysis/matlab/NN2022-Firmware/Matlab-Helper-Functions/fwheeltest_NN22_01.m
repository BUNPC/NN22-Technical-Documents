...
% pref = (28.29e-9/2)*2*(2.8/2)^2/(11.3)^2; % '*2' for two light pipes (dual tip)
pref = (28.29e-9/2)*7.5/(11.3)^2; % Bare flex optode
% filterset = 'full';
...
savestr = sprintf('fwheeltest_NN22_%s_%s.mat',time, filterset);
